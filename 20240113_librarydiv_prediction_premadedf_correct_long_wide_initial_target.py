    ...
    for model_type in ['original']:
        for run_id in [0,1,2,3,4]:
            ...
            for cell_type in cell_types:
                ...
                pridict2_premadedf.insert(len(pridict2_premadedf.columns), f'PRIDICT2_0_editing_Score_deep_{cell_type}', avg_edited_eff)
            pridict2_premadedf.to_csv(f'predictions/20240113_libdiverse_real_long_wide_target_with_pridict2_predictions_{run_id}.csv', index=False)
